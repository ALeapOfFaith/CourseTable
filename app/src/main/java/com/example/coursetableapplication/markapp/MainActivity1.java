package com.example.coursetableapplication.markapp;
                ...
                new AlertDialog.Builder(MainActivity1.this)
                        ...
                        .setPositiveButton("是", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                sqlOpt.delete(flag);
                                Toast.makeText(MainActivity1.this, "已删除", Toast.LENGTH_SHORT).show();
...
//                startActivity(intent);
    ...
    //2的传给1
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent index) {
//    protected void onResume() {
        super.onActivityResult(requestCode, resultCode, index);
//        super.onResume();
        if(requestCode == REQUEST_CODE){
            if(resultCode == RESULT_OK && index != null){
